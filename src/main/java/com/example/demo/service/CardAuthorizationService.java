...
public class CardAuthorizationService {
    ...
    public CardAuthorizationService(GenericSubject<DefaultEvent> eventNotificationGenericSubject) {
        this.eventNotificationGenericSubject = eventNotificationGenericSubject;
    }

    public void process(CardAuthorizationNotification notification) {
        log.info("Inicia processo de autorização");
        this.sendOptInProcess(notification);
    }

    private void sendOptInProcess(CardAuthorizationNotification notification) {
