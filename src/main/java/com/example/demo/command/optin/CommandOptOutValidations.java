...
@Getter
@Setter
public class CommandOptOutValidations extends CommandIGeneric<DefaultEvent> {

    private final GenericSubject<DefaultEvent> linkPaymentSubject;

    public CommandOptOutValidations(final GenericSubject<DefaultEvent> linkPaymentSubject) {
        super(List.of());
